...
const TunerDisplay: React.FC<TunerDisplayProps> = ({ 
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="tuner-display relative h-60 bg-gradient-to-b from-gray-100 to-white rounded-b-lg shadow-inner overflow-hidden border border-gray-200">
        {/* Tuner scale */}
          ...
          <div className="w-full h-1/2 relative">
            ...
            <div className="absolute top-0 left-0 right-0 h-full flex items-center justify-center">
              <div className="w-full relative h-4">
                {/* -50 cents mark */}
                <div className="absolute left-0 top-0 h-4 w-1 bg-red-400"></div>
                
                {/* -40 cents mark */}
                <div className="absolute left-1/10 top-0 h-3 w-0.5 bg-red-300"></div>
                
                {/* -30 cents mark */}
                <div className="absolute left-1/5 top-0 h-4 w-1 bg-red-300"></div>
                
                {/* -20 cents mark */}
                <div className="absolute left-3/10 top-0 h-3 w-0.5 bg-blue-300"></div>
                
                {/* -10 cents mark */}
                <div className="absolute left-2/5 top-0 h-4 w-1 bg-blue-300"></div>
                
                {/* Center (0 cents) mark */}
                <div className="absolute left-1/2 top-0 h-5 w-1 bg-green-500 -translate-x-0.5"></div>
                
                {/* +10 cents mark */}
                <div className="absolute left-3/5 top-0 h-4 w-1 bg-blue-300"></div>
                
                {/* +20 cents mark */}
                <div className="absolute left-7/10 top-0 h-3 w-0.5 bg-blue-300"></div>
                
                {/* +30 cents mark */}
                <div className="absolute left-4/5 top-0 h-4 w-1 bg-red-300"></div>
                
                {/* +40 cents mark */}
                <div className="absolute left-9/10 top-0 h-3 w-0.5 bg-red-300"></div>
                
                {/* +50 cents mark */}
                <div className="absolute right-0 top-0 h-4 w-1 bg-red-400"></div>
              </div>
            </div>
            ...
            <div 
              ref={needleRef} 
              className="tuner-needle absolute bottom-0 left-1/2 w-1 h-1/2 bg-black -translate-x-0.5 shadow-md rounded-t-full"
            ></div>
          </div>
        </div>
        
        {/* Note display */}
        <div className="absolute bottom-0 left-0 right-0 p-4 text-center bg-white/90 backdrop-blur-sm">
          <div className={cn(
            ...
            <div className="flex justify-center items-center">
              {currentNote ? (
                ...
                <span className="text-6xl font-light tracking-tighter text-gray-300">
                  –
                </span>
              )}
            </div>
          ...
          <div className={cn(
            ...
            isTooLow ? "text-blue-500" : 
            isTooHigh ? "text-red-500" : "text-gray-400"
          )}>
            {getStatusMessage()}
          </div>
        </div>
